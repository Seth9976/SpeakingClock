...
int32_t (* var_134_1)(void* arg1, void* arg2) = j_sub_40443c
TEB* fsbase
ExceptionList = fsbase->NtTib.ExceptionList
fsbase->NtTib.ExceptionList = &ExceptionList
uint32_t lpcbData = 5
sub_405fac(&var_121, 0x105)

if (RegQueryValueExA(hKey, &var_121, nullptr, nullptr, &data, &lpcbData) != NO_ERROR
        && RegQueryValueExA(hKey, 0x4063dc, nullptr, nullptr, &data, &lpcbData) != NO_ERROR)
    data = 0

char var_12 = 0
fsbase->NtTib.ExceptionList = ExceptionList
int32_t var_130_2 = 0x40627c
