...
*(arg6 + arg5 + 5 + 0x36d00042) += (arg2 + 1):1.b
edi = &arg6[1]
...
*(entry_ebx + esi_6 + 0x75a40047) = *(entry_ebx + esi_6 + 0x75a40047)
arg4 += 5
label_46a4fb:
...
if (temp2_1 != neg.b((arg2 + 1):1.b) && temp2_1 + (arg2 + 1):1.b u>= temp2_1)
    ...
    *(eax_4 - 9) += (arg2 + 1):1.b
    arg4 = ebp_4 + 2
    (arg2 + 1)[((esi_6 + 1) << 3) + 0x45] += eax_4:1.b
    *(edi + ((esi_6 + 1) << 3) + 0x45) += (arg2 + 1).b
...
*(esp + arg2 + 1) += (arg2 + 1).b
*(esp + arg3 + 1 - 0xaf3ffba) += (arg2 + 1):1.b
*(esi_6 + arg3 + 1) += eax_6.b
*(esi_6 + 1 + ebp_4 + 2 - 0x3397ffb9) += (arg2 + 1).b
*eax_6 += entry_ebx.b
undefined
